        ...
        flows: {
            ...
            logs: {
                ...
                payload: {
                    ...
                    collapse_node: 'Collapse section',
                    empty_array: 'empty array',
                    empty_object: 'empty object',
                    summary_array: '{count} items',
                    summary_object: '{count} keys',
            ...
            editor: {
                ...
                discovery: {
                    ...
                    production_webhook: 'Production',
                    development_webhook: 'Development',
                    copy_webhook: 'Copy URL',
                    open_webhook: 'Open URL',
                    quick_send: 'Quick send JSON',
                    webhook_copied: 'Copied',
                    jump_to_webhook: 'Open webhook',
                    actors_title: 'Actors',
                    events_title: 'Events',
                    actor_label: 'Actor',
                    event_label: 'Event',
        ...
        flows: {
            ...
            logs: {
                ...
                payload: {
                    ...
                    collapse_node: 'Свернуть секцию',
                    empty_array: 'пустой массив',
                    empty_object: 'пустой объект',
                    summary_array: '{count} элементов',
                    summary_object: '{count} ключей',
                    primitive_value: 'Примитивное значение',
                },
                inline: {
                    actor_prefix: 'Актор ',
            ...
            editor: {
                ...
                discovery: {
                    ...
                    webhook_copied: 'Скопировано',
                    jump_to_webhook: 'К вебхуку',
                    actors_title: 'Акторы',
