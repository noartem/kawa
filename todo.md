...
- [ ] Ненужные скругления у codemirror в списке изменений
- [ ] Если несколько изменений свернуты, то между ними сразу два бордера (1px+1px и выглядит более жирно чем должно быть)
